...
function init()
{
    ...
    var runtimeUrl   = 'https://h2909571.stratoserver.net/HellebrekerPackages/ResourceCalendar/External/js/runtime.js';// Microsoft.Dynamics.NAV.GetImageResource('runtime.js');
    var polyfillsUrl = 'https://h2909571.stratoserver.net/HellebrekerPackages/ResourceCalendar/External/js/polyfills.js';// Microsoft.Dynamics.NAV.GetImageResource('polyfills.js');
    var mainUrl      = 'https://h2909571.stratoserver.net/HellebrekerPackages/ResourceCalendar/External/js/main.js';// Microsoft.Dynamics.NAV.GetImageResource('main.js');
